"""Video processing pipeline for railway wheel defect detection."""
...
MODEL_PATH = Path(__file__).resolve().parent.parent / "models" / "rail_surface_yolov8n.pt"

BOX_COLORS_BGR = [
    (229, 69, 96), (15, 52, 96), (0, 184, 148), (253, 203, 110),
    (108, 92, 231), (225, 112, 85), (9, 132, 227), (162, 155, 254),
    (255, 107, 107), (72, 219, 251), (29, 209, 161), (243, 114, 44),
    (95, 39, 215),
]
...
def load_yolo_model():
    ...
    if not MODEL_PATH.exists():
        print(f"Model file not found at {MODEL_PATH}. Please ensure the model is available.")
        return None
